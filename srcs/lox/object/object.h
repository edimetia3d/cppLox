...
struct Object {
   ...
   */
  template <ConcreteObject T, class... Args> static T *Make(Args &&...args) {
   ...
   * the sweeper.
   */
  template <ConcreteObject T, class... Args> static ObjectPtr MakeShared(Args &&...args) {
  ...
  template <ConcreteObject T> T *DynAs() { return dynamic_cast<T *>(this); }

  template <ConcreteObject T> bool Is() { return dynamic_cast<T *>(this); }

  template <ConcreteObject T> const T *DynAs() const { return dynamic_cast<const T *>(this); }

  template <ConcreteObject T> T *As() { return static_cast<T *>(this); }

  template <ConcreteObject T> const T *As() const { return static_cast<const T *>(this); }

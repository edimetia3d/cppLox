...
set(ENABLE_MLIR_JIT_BACKEND "OFF" CACHE BOOL "If set to ON, the project will build with MLIR JIT backend.")

if (${UPSTREAM_STYLE_ERROR_MSG} STREQUAL "ON")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DUPSTREAM_STYLE_ERROR_MSG")
endif ()

if (${ENABLE_MLIR_JIT_BACKEND} STREQUAL "ON")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DENABLE_MLIR_JIT_BACKEND")
endif ()
